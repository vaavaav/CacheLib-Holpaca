...
def main():
    ...
    parser.add_argument("-p", "--prefix", default="opt/cachelib")
    ...
    cmake_flags = [
        ...
        f"-DCMAKE_MODULE_PATH={prefix}/lib/cmake;{script_dir}/cachelib/cmake",
    ...
    # Build main project
    run(["cmake"] + cmake_flags + ["-Bbuild-cachelib", "-Scachelib"])
    run(["make", "-Cbuild-cachelib", f"-j{args.jobs}", "install"])
